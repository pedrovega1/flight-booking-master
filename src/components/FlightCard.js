...
<div className='flex my-2  '>
    ...
    <div>
      ...
      <h5 className='text-gray-700 uppercase font-semibold mx-8 '>{props.flight.dep_iata}</h5>
      <p className='text-gray-500 dark:text-gray-400 mx-8 my-2'>{props.flight.dep_time}</p>
    </div>
    <img 
    className='object-contain h-12 w-24'
