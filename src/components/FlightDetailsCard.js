    ...
    <div>
        ...
        <div className='flex justify-between border border-gray-300'>
           <div className='flex flex-col'>
            <h3 className='text-md text-gray-800 font-semibold'>Dhaka to Dubai </h3>
            <p className='text-sm text-gray-400'>Some random text</p>
            </div> 
            <button onClick={()=> navigate("/search")} className='text-orange-600 rounded-md bg-orange-100 p-2 active:bg-orange-200'>Change Flight</button>
        </div>
        
        <div className='flex py-4 border border-gray-200 '>
            <img
             src="https://www.edigitalagency.com.au/wp-content/uploads/tripadvisor-logo-circle-owl-icon-black-green-858x858.png" alt='logo' 
            ...
            <div className='flex flex-col mr-2'>
                ...
                <p className='text-md text-gray-400'>Dhaka zia international airport Bangladesh</p>
            </div>
            <div className='flex flex-col mr-2'>
                <h3 className='text-lg text-gray-400 font-semibold'>05 hours 20 mins</h3>
