    ...
    <>
      <div className="bg-white rounded-lg border border-gray-400 flex flex-col p-4 ">
        ...
        <div className=" flex flex-col ">
          <div className="flex">
            <div className="flex flex-col">
              <label className="text-gray-500 text-sm mx-2">First Name</label>
              <input
                type="text"
            ...
            <div className="flex flex-col">
              <label className="text-gray-500 text-sm mx-2">Last Name</label>
              <input
                type="text"
      ...
      <div className="bg-white rounded-lg border border-gray-500 flex flex-col p-4 my-5 ">
        <div className="flex justify-between ">
          ...
          <button className="text-gray-6  00 border border-gray-400 rounded-full font-semibold w-1/12 text-sm px-1 py-1">
            Edit
          </button>
        </div>
        ...
        <div className=" flex flex-col ">
          ...
          <div className="flex">
            ...
            <div className="flex flex-col">
              <label className="text-gray-500 text-sm  w-1/2 mx-2">City</label>
              <input type="text" placeholder="City" className="p-2 border  " />
            </div>
          </div>
      ...
      <div className="">
        <button
          ...
          className="inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xm rounded-full shadow-md hover:to-blue-700 hover:shadow-lg focus:to-blue-300"
        >
          Continue
        </button>
      </div>
